  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="Serial Number" width="80" align="center" sortable></el-table-column>
        ...
        <el-table-column prop="time" label="Creation Time"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    delBatch() {   // 批量删除
      ...
      this.$confirm('Are you sure you want to batch delete these data?', 'Confirm Delete', {type: "warning"}).then(response => {
